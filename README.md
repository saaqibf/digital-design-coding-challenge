# Digital Design Coding Challenge
...
That link pattern is the same one Callysto uses for its own hackathons: click it, log in, and challenge-0 opens ready to run.
...
Built by Saaqib Fagbenro, MindFuel Foundation internship, summer 2026.
